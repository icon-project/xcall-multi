...
public fun get_creator(self:&SwapOrder):vector<u8> {
    self.creator
}
public fun get_destination_address(self:&SwapOrder):vector<u8> {
    self.destination_address
}
public fun get_to_token(self:&SwapOrder):vector<u8> {
    self.to_token
}
...
public fun get_token(self:&SwapOrder):vector<u8> {
    return self.token
}
