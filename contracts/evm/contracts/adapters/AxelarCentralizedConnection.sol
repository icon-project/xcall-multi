...
import "@iconfoundation/xcall-solidity-library/interfaces/IAxelarGateway.sol";
...
contract CentralizedConnection is Initializable, IConnection {
    ...
    mapping(string => mapping(uint256 => bool)) receipts;
     mapping(string => string) private nidToChain;
     mapping(string => string) private nidToTargetAddress;
    ...
    function initialize(address _relayer, address _xCall,address gatewayAddress) public initializer {
        xCall = _xCall;
    ...
    */
    ...
    function sendMessage(
        ...
        string memory destinationChain=nidToChain[to];
        string memory destinationContractAddress=nidToTargetAddress[to];
        IAxelarGateway(gatewayAddress).callContract(destinationChain, destinationContractAddress, _msg);
    ...
    */
    function admin() external view returns (address) {
     ...
     function setDestinationChain(
        ...
        nidToChain[networkId] = chainName;
        nidToTargetAddress[networkId] = targetAddress;
    }
}
